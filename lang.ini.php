...
$_lang['en'] = [
    ...
    'compare_relative' => 'Start relative to "nagare" (sec)',
    ...
    'compare_base' => '"nagare" at (sec)',
    'compare_base_unset' => 'Not set',
    'compare_base_here' => 'Mark current position as "nagare"',
...
$_lang['ko'] = [
    ...
    'compare_relative' => '「ながれ」 기준 시작 위치(초)',
    ...
    'compare_base' => '「ながれ」 위치(초)',
    'compare_base_unset' => '미설정',
    'compare_base_here' => '현재 위치를 「ながれ」로 지정',
